...
public:
	...
	static const UINT WM_ERROR = WM_APP + 1;
	static const UINT WM_PROGRESS_START = WM_APP + 2;
	static const UINT WM_PROGRESS = WM_APP + 3;
	static const UINT WM_DONE = WM_APP + 4;
...
private:
	...
	static void CALLBACK ReadCallback(
	...
	static void CALLBACK WriteCallback(
		_Inout_     PTP_CALLBACK_INSTANCE Instance,
		_Inout_opt_ PVOID                 Context,
		_Inout_opt_ PVOID                 Overlapped,
		_In_        ULONG                 IoResult,
	...
	static const int chunkSize = 1 << 16;	// 64 KB
	LONG64 m_OperationCount;
