...
public:
	...
	BEGIN_MSG_MAP(CMainDlg)
		...
		COMMAND_ID_HANDLER(IDC_RELEASE, OnRelease)
		COMMAND_ID_HANDLER(IDC_RELEASEALL, OnReleaseAll)
...
private:
	...
	LRESULT OnRelease(WORD /*wNotifyCode*/, WORD wID, HWND /*hWndCtl*/, BOOL& /*bHandled*/);
	LRESULT OnReleaseAll(WORD /*wNotifyCode*/, WORD wID, HWND /*hWndCtl*/, BOOL& /*bHandled*/);
